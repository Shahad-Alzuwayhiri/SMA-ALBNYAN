...
<head>
    ...
    <title>العقود - نظام إدارة العقود سما</title>
...
<body>
    ...
    <div class="page-header">
        <div class="container">
            <h1><i class="fas fa-file-contract me-3"></i>إدارة العقود</h1>
            <p class="mb-0">عرض وإدارة جميع العقود في النظام</p>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-3">
                <div class="stats-card">
                    <div class="stats-number"><?php echo count(array_filter($contracts, fn($c) => $c['status'] === 'active')); ?></div>
                    <div class="stats-label">العقود النشطة</div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="stats-card">
                    <div class="stats-number"><?php echo count(array_filter($contracts, fn($c) => $c['status'] === 'pending')); ?></div>
                    <div class="stats-label">قيد المراجعة</div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="stats-card">
                    <div class="stats-number"><?php echo number_format(array_sum(array_column($contracts, 'contract_amount')), 0); ?></div>
                    <div class="stats-label">إجمالي القيمة (ريال)</div>
                </div>
            </div>
        </div>
