...
<body>
    <div class="dashboard-container">
        ...
        <div class="nav-container">
            <a href="<?php echo asset('dashboard.php'); ?>" class="nav-link">🏠 لوحة التحكم</a>
            <a href="<?php echo asset('contracts.php'); ?>" class="nav-link active">📄 العقود</a>
            <a href="<?php echo asset('contracts/create'); ?>" class="nav-link">➕ عقد جديد</a>
            <a href="<?php echo asset('contracts-in-progress'); ?>" class="nav-link">🔄 قيد التنفيذ</a>
            <a href="<?php echo asset('contracts-closed'); ?>" class="nav-link">✅ مكتملة</a>
            <a href="<?php echo asset('notifications.php'); ?>" class="nav-link">🔔 الإشعارات</a>
            <a href="<?php echo asset('logout.php'); ?>" class="nav-link">� تسجيل الخروج</a>
        </div>
