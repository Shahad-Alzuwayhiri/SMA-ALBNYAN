    ...
    <div class="page-container">
        <div class="auth-container">
            <div class="glass-container">
                ...
                <form class="login-form" method="POST" action="<?php echo asset('forgot-password'); ?>" id="forgotPasswordForm">
                ...
                <div class="auth-links">
                    ...
                    <p>ليس لديك حساب؟ <a href="<?php echo asset('register.php'); ?>" class="link-secondary">إنشاء حساب جديد</a></p>
                </div>
