 ...
 * Emits the canonical DOCTYPE as the very first bytes of the response.
 * Any fragments/includes must NOT emit DOCTYPE or top-level HTML tags.
 */

// Defensive: compute BASE_URL and the asset() helper before emitting HTML.
...
// Initialize commonly used variables (do not echo here)
...
// Determine authentication state without producing output
$user = null;
...
<head>
    ...
    <!-- UI Frameworks (Bootstrap, FontAwesome) -->
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css" rel="stylesheet">

    <!-- Base Styles -->
    <link rel="stylesheet" href="<?= asset('assets/css/unified-theme.css') ?>">
    ...
    <style>
        ...
        * {
        ...
        /* Auth Page Styling (aligned with signup visual theme) */
        .auth-layout {
            display: flex;
            align-items: center;
        ...
        .auth-logo h1 { color: #253355; font-weight: 700; }
        .auth-logo p { color: #77bcc3; margin: 0; }
