...
<head>
    ...
    if (!function_exists('asset')) {
        error_log('asset() helper not found after require.');
        die('Critical error: asset() helper missing.');
    }
    ?>
    <meta charset="UTF-8">
    ...
    <div class="page-container">
        <div class="auth-container">
            <div class="glass-container">
                ...
                <form class="login-form" method="POST" action="<?php echo asset('reset-password'); ?>" id="resetPasswordForm">
                ...
                <div class="auth-links">
                    <p>تذكرت كلمة المرور؟ <a href="<?php echo asset('login.php'); ?>" class="link-primary">تسجيل الدخول</a></p>
                </div>
